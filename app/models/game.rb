class Game < ActiveRecord::Base
  ...
  def change_turn!
    # if current player who played move_to! just now was the white_player
    # then update the turn to the black_player
    if current_user.pieces.move_to! == white_player_id
